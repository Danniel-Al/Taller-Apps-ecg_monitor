...
class UserData {
  // Datos básicos
  String username;
  bool hasCompletedDemographics;  // ¿Ya llenó los datos?
  ...
  // Convertir a mapa (para guardar en SharedPreferences después)
  ...
  // Crear desde mapa (para cargar desde SharedPreferences después)
